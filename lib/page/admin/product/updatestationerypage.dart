...
import 'package:one_store/data/model/admin/stationerymodeladmin.dart';
...
class _UpdateStationeryPageState extends State<UpdateStationeryPage> {
  ...
  void initState() {
    ...
    _materialController =
        TextEditingController(text: widget.stationery.material);
    _originalPriceController =
        TextEditingController(text: widget.stationery.originalPrice.toString());
    _sellingPriceController =
        TextEditingController(text: widget.stationery.sellingPrice.toString());
    _sizeController = TextEditingController(text: widget.stationery.size);
    _weightController =
        TextEditingController(text: widget.stationery.weight.toString());
    _quantityController =
        TextEditingController(text: widget.stationery.quantity.toString());
    _descriptionController =
        TextEditingController(text: widget.stationery.description);
  }
